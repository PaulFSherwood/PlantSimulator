...
\begin{document}
\begin{tikzpicture}[
  yshift=-3cm, % moves everything down
  process/.style={rectangle, rounded corners, draw=blue!50, fill=blue!10,
                  very thick, minimum width=3cm, minimum height=1cm, align=center},
  util/.style={rectangle, draw=orange!70!black, fill=orange!10,
